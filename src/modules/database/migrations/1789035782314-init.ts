...
export class Init1789035782314 implements MigrationInterface {
    name = 'Init1789035782314'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "review" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "data" jsonb NOT NULL, "reviewerId" uuid NOT NULL, "activityId" uuid NOT NULL, CONSTRAINT "UQ_d00d1c44db472a6fd8d420ccd34" UNIQUE ("reviewerId", "activityId"), CONSTRAINT "PK_2e4299a343a81574217255c00ca" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "activity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "name" character varying(150) NOT NULL, "slug" character varying(180) NOT NULL, "description" text, "startDate" TIMESTAMP WITH TIME ZONE NOT NULL, "endDate" TIMESTAMP WITH TIME ZONE NOT NULL, "participationForm" jsonb NOT NULL DEFAULT '{}'::jsonb, "isPublished" boolean NOT NULL DEFAULT false, "reviewForm" jsonb NOT NULL DEFAULT '{}'::jsonb, "cover" character varying(255), "programId" uuid NOT NULL, CONSTRAINT "UQ_cd3ee671fae680bfbb3ae0ef424" UNIQUE ("slug"), CONSTRAINT "PK_24625a1d6b1b089c8ae206fe467" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."participation_status_enum" AS ENUM('pending', 'approved', 'declined')`);
        await queryRunner.query(`CREATE TABLE "participation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "data" jsonb NOT NULL DEFAULT '{}'::jsonb, "status" "public"."participation_status_enum" NOT NULL DEFAULT 'pending', "participantId" uuid NOT NULL, "activityId" uuid NOT NULL, CONSTRAINT "UQ_cfea5c2b014d8e011e2d7a76875" UNIQUE ("participantId", "activityId"), CONSTRAINT "PK_ba5442bab90fc96ddde456c69e1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "name" character varying NOT NULL, "email" character varying NOT NULL, "avatar" character varying, "jobTitle" character varying, "password" character varying, "biography" text NOT NULL, "socialLinks" jsonb NOT NULL DEFAULT '{}'::jsonb, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "review" ADD CONSTRAINT "FK_6ebc6b377e1e197dc470da3e810" FOREIGN KEY ("activityId") REFERENCES "activity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "participation" ADD CONSTRAINT "FK_f48126fafb856a48373bbd7bcc8" FOREIGN KEY ("participantId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "participation" ADD CONSTRAINT "FK_957a684f4de09e9c8624f48d4c9" FOREIGN KEY ("activityId") REFERENCES "activity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "participation" DROP CONSTRAINT "FK_957a684f4de09e9c8624f48d4c9"`);
        await queryRunner.query(`ALTER TABLE "participation" DROP CONSTRAINT "FK_f48126fafb856a48373bbd7bcc8"`);
        await queryRunner.query(`ALTER TABLE "activity" DROP CONSTRAINT "FK_4b6f54c9ff59d01665ecb4707ff"`);
        await queryRunner.query(`ALTER TABLE "review" DROP CONSTRAINT "FK_6ebc6b377e1e197dc470da3e810"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."participation_status_enum"`);
